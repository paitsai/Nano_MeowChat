...
from model.model_nanolm import NanoLMConfig, NanoLMForCausalLM
...
def init_model(args):
    ...
    if 'model' in args.load_from:
        model = NanoLMForCausalLM(NanoLMConfig(
...
def main():
    parser = argparse.ArgumentParser(description="NanoLM模型推理与对话")
    ...
    parser.add_argument('--num_hidden_layers', default=24, type=int, help="隐藏层数量（Small/MoE=8, Base=16）")
